...
function Navbar() {
    ...
    return (
        <nav className="fixed top-0 left-0 w-full z-50 flex flex-col bg-background/80 backdrop-blur-md shadow-sm">
            <div className="max-w-[1200px] w-full mx-auto flex justify-between items-center p-4 h-full text-main">
                {/* Logo */}
                <motion.div
